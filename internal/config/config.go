...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "file-service")
	...
	v.SetDefault("database.schema", "file")
	...
	v.SetDefault("jwt.issuer", "file-service")
	...
	v.SetDefault("auth.audience", "file-service")
	...
	v.SetDefault("migration.table", "file_schema_migrations")
	...
	v.SetDefault("object_storage.bucket", "platform-files")
